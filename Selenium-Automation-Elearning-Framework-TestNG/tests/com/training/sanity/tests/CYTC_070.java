...
public class CYTC_070 {
	...
	public void validLoginTestAdmin() {
		...
		screenShot.captureScreenShot("Login_15_1");
		//click Login
	...
	public void advertisementTest(String userName, String title, String category, String price, String description) throws Exception {
		...
		screenShot.captureScreenShot("CYTC_070_1");
		//Submit the details
		addAdvPOM.clickSave();
		//Alert popup expected value
		expectedResult = "Description is required";
		//Alert popup actual value
		actualResult = addAdvPOM.acceptAlert().replaceAll("\n","");
		//Click Back button
		addAdvPOM.clickBack();		
		screenShot.captureScreenShot("CYTC_070_2");
		addAdvPOM.clickHome();
