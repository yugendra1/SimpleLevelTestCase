...
public class CYTC_066 {
	...
	public void validLoginTestAdmin() {
		...
		screenShot.captureScreenShot("Login_11_1");
		//click Login
	...
	@Test(priority=2, dataProvider = "excel-inputs", dataProviderClass = AccessDataProviders.class)
	public void accessTest(String userName, String access, String comment) throws Exception {
		...
		screenShot.captureScreenShot("CYTC_066_1");
		//Submit the details
		...
		screenShot.captureScreenShot("CYTC_066_2");
